 ...
 * SEMRush
 */
public class AmazonMultiLangTest {
    private static final Logger log = getLogger(AmazonMultiLangTest.class);

    public static void main(String[] args) throws IOException, LangDetectException {
        String sUrl = "https://www.amazon.de/gp/product/B004V9OA84/ref=pd_sim_351_3?ie=UTF8&psc=1&refRID=Q479H7YW5N77WMS5XDC6";
